...
namespace Avalonia.Documents
{
    ...
    /// 
    ///     - The TextContainer constructor takes an optional AvaloniaObject argument
    ...
    internal class TextContainer : ITextContainer
    {
        ...
        /// </summary>
        /// <param name="parent">
        /// A AvaloniaObject used to supply inherited property values for
        ...
        /// </param>
        internal TextContainer(AvaloniaObject parent, bool plainTextOnly)
        {
            _parent = parent;
        ...
        internal void EnableUndo(Control uiScope)
        {
            //Invariant.Assert(_undoManager == null, SR.Get(SRID.TextContainer_UndoManagerCreatedMoreThanOnce));

            _undoManager = new UndoManager();
            Avalonia.Documents.UndoManager.AttachUndoManager(uiScope, _undoManager);
        }

        internal void DisableUndo(Control uiScope)
        {
            //Invariant.Assert(_undoManager != null, "UndoManager not created.");

            //Invariant.Assert(_undoManager == Avalonia.Documents.UndoManager.GetUndoManager(uiScope));

            Avalonia.Documents.UndoManager.DetachUndoManager(uiScope);
            _undoManager = null;
        }
...
//        }
        ...
        object ITextContainer.GetAdjacentElement(StaticTextPointer position, LogicalDirection direction)
        {
            TextTreeNode node = (TextTreeNode)position.Handle0;
            int nodeOffset = position.Handle1;
            AvaloniaObject adjacentElement;
        ...
        AvaloniaObject ITextContainer.GetParent(StaticTextPointer position)
        {
        ...
        {
            AvaloniaObject parent = GetScopingNode(position).GetDependencyParent();
        ...
        internal void InsertElementInternal(TextPointer startPosition, TextPointer endPosition, TextElement element)
        {
            ...
            AvaloniaObject parentLogicalNode;
            bool newElementNode;
            int deltaCharCount;
        ...
        internal void InsertEmbeddedObjectInternal(TextPointer position, AvaloniaObject embeddedObject)
        {
...
//                 VerifyAccess();
        ...
        /// May be null.
        /// </remarks>
        internal AvaloniaObject Parent
        {
            get
            {
//                 VerifyAccess();
        ...
        AvaloniaObject ITextContainer.Parent
        {
            get
            {
                return this.Parent;
        ...
        // about a new parent.
        private void ReparentLogicalChildren(SplayTreeNode containerNode, AvaloniaObject newParentLogicalNode, AvaloniaObject oldParentLogicalNode)
        {
        ...
        // calls AddLogicalChild methods if supported to alert the children
        // about a new parent.
        private void ReparentLogicalChildren(SplayTreeNode firstChildNode, SplayTreeNode lastChildNode, AvaloniaObject newParentLogicalNode, AvaloniaObject oldParentLogicalNode)
        {
            SplayTreeNode node;
            AvaloniaObject logicalTreeNode;
            TextTreeTextElementNode elementNode;
        ...
        private char[] ExtractElementInternal(TextElement element, bool deep, out ExtractChangeEventArgs extractChangeEventArgs)
        {
            ...
            AvaloniaObject oldLogicalParent;
        ...
        // Parent AvaloniaObject, supplied in ctor.  May be null.
        private readonly AvaloniaObject _parent;
