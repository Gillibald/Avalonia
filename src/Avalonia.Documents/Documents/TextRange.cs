...
namespace Avalonia.Documents
{
    ...
    public class TextRange : ITextRange
    {
        ...
        /// <summary>
        /// <see cref="ITextRange.ApplyTypingHeuristics"/>
        /// </summary>
...
#pragma warning suppress 6506 // formattingProperty is obviously not null
            ...
            {
                var typeConverter = System.ComponentModel.TypeDescriptor.GetConverter(formattingProperty.PropertyType);
...
#pragma warning suppress 6506 // formattingProperty is obviously not null
        ...
        internal void InsertEmbeddedUIElement(IStyledElement embeddedElement)
        {
        ...
        internal IStyledElement ContainingFrameworkElement
        {
            get
            {
        ...
        internal string Xml
        {
            ...
            set
            {
                ...
                try
                {
                    ...
                    object xamlObject = XamlReader.Load(new XmlTextReader(new StringReader(value)), _useRestrictiveXamlXmlReader);
                    TextElement fragment = xamlObject as TextElement;

                    if (fragment != null)
                    {
                        SetXmlVirtual(fragment);
                    }
                }
                finally
                {
        ...
        internal virtual void InsertEmbeddedUIElementVirtual(IStyledElement embeddedElement)
        {
            ...
            try
            {
                ...
                TextPointer startPosition = TextRangeEditTables.EnsureInsertionPosition(Start);
                ...
                if (paragraph != null)
                {
                    ...
                    else
                    {
                        ...
                        TextPointer insertionPosition = TextRangeEdit.SplitFormattingElements(Start, /*keepEmptyFormatting:*/false);
        ...
        //        {
        //            var textSegment = _textSegments[i];
