...
namespace Avalonia.Documents
{
    ...
    internal class UndoManager
    {
        ...
        internal static void DetachUndoManager(IAvaloniaObject scope)
        {
            ...
            undoManager = scope.ReadLocalValue(UndoManagerInstanceProperty) as UndoManager;
            if (undoManager != null)
            {
        ...
        private IUndoUnit PopUndoStack()
        {
            ...
            var unit = UndoStack[_topUndoIndex];
        ...
        /// </summary>
        private static readonly AvaloniaProperty UndoManagerInstanceProperty = AvaloniaProperty.RegisterAttached<UndoManager, IAvaloniaObject, UndoManager>( //
            "UndoManagerInstance", null, true);
