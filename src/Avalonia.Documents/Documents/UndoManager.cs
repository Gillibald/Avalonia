...
namespace Avalonia.Documents
{
    ...
    internal class UndoManager
    {
        ...
        /// </param>
        internal static void AttachUndoManager(AvaloniaObject scope, UndoManager undoManager)
        {
            if (scope == null)
            {
            ...
            if (undoManager is UndoManager && undoManager._scope != null)
            {
                throw new InvalidOperationException("UndoManagerAlreadyAttached");
            }
            ...
            {
                Debug.Assert(undoManager._scope == null);
        ...
        /// </remarks>
        internal static void DetachUndoManager(AvaloniaObject scope)
        {
            ...
            undoManager = scope.GetValue(UndoManagerInstanceProperty) as UndoManager;
            if (undoManager != null)
            {
                ...
                if (undoManager is UndoManager)
                {
                    Debug.Assert(undoManager._scope == scope);
        ...
        /// </param>
        /// <returns></returns>
        internal static UndoManager GetUndoManager(AvaloniaObject target)
        {
            if (target == null)
            {
                return null;
        ...
        internal void Open(IParentUndoUnit unit)
        {
            ...
            if (!IsEnabled)
            {
                throw new InvalidOperationException("UndoServiceDisabled");
            }
            ...
            if (deepestOpen == unit)
            {
                throw new InvalidOperationException("UndoUnitCantBeOpenedTwice");
            }
        ...
        internal void Reopen(IParentUndoUnit unit)
        {
            ...
            if (OpenedUnit != null)
            {
                throw new InvalidOperationException("UndoUnitAlreadyOpen");
            }
                ...
                case UndoState.Redo:
                    {
                        ...
                        {
                            throw new InvalidOperationException("UndoUnitNotOnTopOfStack");
                        }
            ...
            if (unit.Locked)
            {
                throw new InvalidOperationException("UndoUnitLocked");
            }
        ...
        internal void Close(IParentUndoUnit unit, UndoCloseAction closeAction)
        {
            ...
            if (OpenedUnit == null)
            {
                throw new InvalidOperationException("SRID.UndoNoOpenUnit");
            }
            ...
            if (OpenedUnit != unit)
            {
                ...
                {
                    throw new ArgumentException("UndoUnitNotFound", nameof(unit));
                }
        ...
        internal void Add(IUndoUnit unit)
        {
            ...
            {
                throw new InvalidOperationException("UndoNoOpenParentUnit");
            }
        }
        ...
        internal void Undo(int count)
        {
            ...
            {
                throw new InvalidOperationException("UndoNotInNormalState");
            }

            if (OpenedUnit != null)
            {
                throw new InvalidOperationException("UndoUnitOpen");
            }
        ...
        /// </summary>
        private static readonly AttachedProperty<UndoManager> UndoManagerInstanceProperty = AvaloniaProperty.RegisterAttached<UndoManager, Control, UndoManager>("UndoManagerInstance", null, true);
        ...
        private AvaloniaObject _scope; // an element to which this instance of scope is attached
