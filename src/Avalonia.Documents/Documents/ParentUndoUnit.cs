...
namespace Avalonia.Documents
{
    ...
    internal class ParentUndoUnit : IParentUndoUnit
    {
        ...
        public virtual void Close(IParentUndoUnit unit, UndoCloseAction closeAction)
        {
            ...
            if (OpenedUnit == null)
            {
                throw new InvalidOperationException("UndoNoOpenUnit");
            }
            ...
            if (OpenedUnit != unit)
            {
                ...
                {
                    throw new ArgumentException("UndoUnitNotFound", "unit");
                }
        ...
        public virtual void Add(IUndoUnit unit)
        {
            ...
            {
                throw new InvalidOperationException("UndoUnitCantBeAddedTwice");
            }
        ...
        public object Container
        {
            ...
            set
            {
                ...
                {
                    throw new Exception("UndoContainerTypeMismatch");
                }
                _container = value;
            }
        }
