...
namespace Avalonia.Documents
{
    ...
    public abstract class Block : TextElement
    {
        ...
        static Block()
        {
            AffectsRender<Block>(IsHyphenationEnabledProperty);
            AffectsMeasure<Block>(IsHyphenationEnabledProperty);
        }
        ...
        /// </summary>
        public static readonly AvaloniaProperty IsHyphenationEnabledProperty =
                AvaloniaProperty.RegisterAttached<Block, Block, bool>(
                        "IsHyphenationEnabled", false, true);
        ...
        public static void SetIsHyphenationEnabled(IAvaloniaObject element, bool value)
        {
            if (element == null)
            {
        ...
        public static bool GetIsHyphenationEnabled(IAvaloniaObject element)
        {
            if (element == null)
            {
                throw new ArgumentNullException("element");
