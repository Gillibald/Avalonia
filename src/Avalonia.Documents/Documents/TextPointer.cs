...
namespace Avalonia.Documents
{
    ...
    /// a <see cref="GetOffsetToPosition"/> method).</para>
    ...
    /// <see cref="LogicalDirection"/> property.</para>
    ...
    /// get from a TextPointer using method <see cref="GetPointerContext"/>.</para>
    ...
    /// using traversal methods like <see cref="GetNextContextPosition"/>,
    /// <see cref="GetNextInsertionPosition"/>, <see cref="GetPositionAtOffset(int)"/>,
    ...
    // Internal comments:
    //
    // TextContainer's implementation of the Text OM TextPointer interface.
    //
    ...
    public class TextPointer : ContentPosition, ITextPointer
    {
        ...
        // Constructor equivalent to TextPointer.CreatePointer
        ...
        /// text container as this TextPointer (you can use <see cref="IsInSameDocument"/>
        ...
        public TextPointerContext GetPointerContext(LogicalDirection direction)
        {
            ...
            return direction == LogicalDirection.Forward ? GetPointerContextForward(_node, Edge) : GetPointerContextBackward(_node, Edge);
        }
        ...
        public int GetTextRunLength(LogicalDirection direction)
        {
            ...
            if (_tree.PlainTextOnly)
            {
                ...
                {
                    count = _tree.InternalSymbolCount - GetSymbolOffset() - 1;
                }
                else
                {
                    count = GetSymbolOffset() - 1;
                }
            }
            else
            {
        ...
        /// <para>- opening or closing tag of a <see cref="TextElement"/>.</para>
        /// <para>- the whole <see cref="UIElement"/> as atomic embedded object.</para>
        /// <para>See examples in <seealso cref="GetPositionAtOffset(int)"/> method with one parameter.</para>
        /// </remarks>
        ...
        {
            return GetNextContextPosition(direction);
        }
        ...
        {
            return GetInsertionPosition(direction);
        }
        ...
        /// "insertion position" in the <see cref="GetInsertionPosition(LogicalDirection)"/>
        /// method.</para>
        ...
        {
            return GetNextInsertionPosition(direction);
        }
        ...
        public TextPointer GetLineStartPosition(int count)
        {
            ...
            var lineStartPosition = GetLineStartPosition(count, out actualCount);
        ...
        public int DeleteTextInRun(int count)
        {
            ...
            int maxDeleteCount = GetTextRunLength(direction);
        ...
        public TextPointer InsertParagraphBreak()
        {
            ...
            {
                var containerType = TextContainer.Parent.GetType();
            ...
            var ancestor = GetNonMergeableInlineAncestor();
        ...
        {
#if DEBUG
            return "TextPointer Id=" + _debugId + " NodeId=" + _node.DebugId + " Edge=" + Edge;
#else
        ...
        public bool IsAtLineStartPosition
        {
            get
            {
                ...
                {
                    TextPointer position = new TextPointer(this);
                    var backwardContext = position.GetPointerContext(LogicalDirection.Backward);
        ...
        /// <para>The <see cref="Parent"/> property for this
        ...
        {
            Inline ancestor = Parent as Inline;
        ...
        {
            TextElement ancestor = Parent as TextElement;
        ...
        internal void InsertUIElement(UIElement uiElement)
        {
            ...
            if (!((TextElement)Parent).IsEmpty) // the parent may be InlineUIContainer or BlockUIContainer
            {
        ...
        internal void SetLogicalDirection(LogicalDirection direction)
        {
            ...
            if (GetGravityInternal() != direction)
            {
                ...
                SetNodeAndEdge(AdjustRefCounts((TextTreeNode)newNode, edge, _node, Edge), edge);
        ...
        void TextPointer.SetLogicalDirection(LogicalDirection direction)
        {
            SetLogicalDirection(direction);
        }

        int TextPointer.CompareTo(TextPointer position)
        {
            return CompareTo(position);
        }

        int TextPointer.CompareTo(StaticTextPointer position)
        {
            int offsetThis;
            int offsetPosition;
            int result;
        ...
        int TextPointer.GetOffsetToPosition(TextPointer position)
        {
            return GetOffsetToPosition(position);
        }

        TextPointerContext TextPointer.GetPointerContext(LogicalDirection direction)
        {
            return GetPointerContext(direction);
        }

        int TextPointer.GetTextRunLength(LogicalDirection direction)
        {
            return GetTextRunLength(direction);
        }

        // <see cref="System.Windows.Documents.TextPointer.GetTextInRun"/>
        string TextPointer.GetTextInRun(LogicalDirection direction)
        {
            return TextPointerBase.GetTextInRun(this, direction);
        }

        int TextPointer.GetTextInRun(LogicalDirection direction, char[] textBuffer, int startIndex, int count)
        {
            return GetTextInRun(direction, textBuffer, startIndex, count);
        }

        object TextPointer.GetAdjacentElement(LogicalDirection direction)
        {
            return GetAdjacentElement(direction);
        }

        Type TextPointer.GetElementType(LogicalDirection direction)
        {
            DependencyObject element;
        ...
        bool TextPointer.HasEqualScope(TextPointer position)
        {
        ...
        TextPointer TextPointer.GetNextContextPosition(LogicalDirection direction)
        {
        ...
        TextPointer TextPointer.GetInsertionPosition(LogicalDirection direction)
        {
            var pointer = CreatePointer();
        ...
        TextPointer TextPointer.GetFormatNormalizedPosition(LogicalDirection direction)
        {
            var pointer = CreatePointer();
        ...
        TextPointer TextPointer.GetNextInsertionPosition(LogicalDirection direction)
        {
            var pointer = CreatePointer();
        ...
        object TextPointer.GetValue(DependencyProperty formattingProperty)
        {
        ...
        object TextPointer.ReadLocalValue(DependencyProperty formattingProperty)
        {
            TextElement element;
        ...
        LocalValueEnumerator TextPointer.GetLocalValueEnumerator()
        {
            DependencyObject element;
        ...
        {
            return ((TextPointer)this).CreatePointer(0, LogicalDirection);
        }

        StaticTextPointer TextPointer.CreateStaticPointer()
        {
            _tree.EmptyDeadPositionList();
            SyncToTreeGeneration();
        ...
        TextPointer TextPointer.CreatePointer(int offset)
        {
            return ((TextPointer)this).CreatePointer(offset, LogicalDirection);
        }

        TextPointer TextPointer.CreatePointer(LogicalDirection gravity)
        {
            return ((TextPointer)this).CreatePointer(0, gravity);
        }

        TextPointer TextPointer.CreatePointer(int offset, LogicalDirection gravity)
        {
            return new TextPointer(this, offset, gravity);
        }

        // <see cref="TextPointer.Freeze"/>
        void TextPointer.Freeze()
        {
            Freeze();
        }

        TextPointer TextPointer.GetFrozenPointer(LogicalDirection logicalDirection)
        {
            return GetFrozenPointer(logicalDirection);
        }

        // Worker for Min, accepts any TextPointer.
        bool TextPointer.MoveToNextContextPosition(LogicalDirection direction)
        {
            return MoveToNextContextPosition(direction);
        }

        int TextPointer.MoveByOffset(int offset)
        {
            return MoveByOffset(offset);
        }

        void TextPointer.MoveToPosition(TextPointer position)
        {
            MoveToPosition(position);
        }

        void TextPointer.MoveToElementEdge(ElementEdge edge)
        {
        ...
        internal void MoveToElementEdge(ElementEdge edge)
        {
            ...
            var scopingNode = GetScopingNode();
        ...
        int TextPointer.MoveToLineBoundary(int count)
        {
            return MoveToLineBoundary(count);
        }

        // <see cref="TextPointer.GetCharacterRect"/>
        Rect TextPointer.GetCharacterRect(LogicalDirection direction)
        {
            return GetCharacterRect(direction);
        }

        bool TextPointer.MoveToInsertionPosition(LogicalDirection direction)
        {
            return MoveToInsertionPosition(direction);
        }

        bool TextPointer.MoveToNextInsertionPosition(LogicalDirection direction)
        {
        ...
        void TextPointer.InsertTextInRun(string textData)
        {
        ...
        void TextPointer.DeleteContentToPosition(TextPointer limit)
        {
            _tree.BeginChange();
            try
            {
                // DeleteContent is clever enough to handle the this > limit case.
                TextRangeEditTables.DeleteContent(this, limit);
            }
            finally
            {
                _tree.EndChange();
        ...
        /// <see cref="ValidateLayout"/>
        bool TextPointer.ValidateLayout()
        {
        ...
        // <see cref="System.Windows.Documents.TextPointer.ParentType"/>
        Type TextPointer.ParentType
        {
            get
            {
                _tree.EmptyDeadPositionList();
        ...
        /// </summary>
        ITextContainer TextPointer.TextContainer
        {
            get
            {
        ...
        bool TextPointer.HasValidLayout
        {
            get
            {
        ...
        // <see cref="TextPointer.IsAtCaretUnitBoundary"/>
        bool TextPointer.IsAtCaretUnitBoundary
        {
            get
            {
                _tree.EmptyDeadPositionList();
        ...
        bool TextPointer.IsAtInsertionPosition
        {
            get { return IsAtInsertionPosition; }
        }

        // <see cref="TextPointer.IsFrozen"/>
        bool TextPointer.IsFrozen
        {
            get
            {
                return IsFrozen;
        ...
        // <see cref="TextPointer.Offset"/>
        int TextPointer.Offset
        {
            get
            {
                return Offset;
        ...
        {
            return Edge == ElementEdge.BeforeStart || Edge == ElementEdge.BeforeEnd ? LogicalDirection.Forward : LogicalDirection.Backward;
        }
