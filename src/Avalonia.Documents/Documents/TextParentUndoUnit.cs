...
namespace Avalonia.Documents
{
    ...
    internal class TextParentUndoUnit : ParentUndoUnit
    {
        ...
        public override void Do()
        {
            ...
            var anchorPosition = textContainer.CreatePointerAtOffset(_undoAnchorPositionOffset, _undoAnchorPositionDirection);
            var movingPosition = textContainer.CreatePointerAtOffset(_undoMovingPositionOffset, _undoMovingPositionDirection);
