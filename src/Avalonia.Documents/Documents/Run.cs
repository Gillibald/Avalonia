...
namespace Avalonia.Documents
{
    ...
    public class Run : Inline
    {
        ...
        /// </remarks>
        public static readonly AvaloniaProperty TextProperty = AvaloniaProperty.Register<Run, string>("Text",
            string.Empty, defaultBindingMode: BindingMode.TwoWay, coerce: CoerceText);
        ...
        private static void OnTextPropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            ...
            if (document != null)
            {
                ...
                if (rtb != null && run.HasExpression(run.LookupEntry(TextProperty.GlobalIndex), TextProperty))
                {
