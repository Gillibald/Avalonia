...
namespace Avalonia.Documents 
{
    ...
    public class Run : Inline
    {
        ...
        /// </remarks>
        public static readonly AvaloniaProperty TextProperty = AvaloniaProperty.Register<Run, string>("Text", string.Empty, false, BindingMode.TwoWay, 
                /*new PropertyChangedCallback(OnTextPropertyChanged),*/ coerce: CoerceText);
        ...
        /// </remarks>
        private static void OnTextPropertyChanged(AvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            Run run = (Run)d;
