...
namespace Avalonia.Documents
{
    ...
    public class TextElementCollection<TextElementType> : IList, ICollection<TextElementType> where TextElementType : TextElement
    {
        ...
        /// </param>
        internal TextElementCollection(AvaloniaObject owner, bool isOwnerParent)
        {
            if (isOwnerParent)
            {
        ...
        public bool Contains(TextElementType item)
        {
            ...
            for (element = FirstChild; element != null; element = (TextElementType)element.NextElement)
            {
                if (element == item)
                    break;
            }
        ...
        public void InsertAfter(TextElementType previousSibling, TextElementType newItem)
        {
            ...
            {
                throw new ArgumentException(SR.Get(SRID.TextSchema_TheChildElementBelongsToAnotherTreeAlready, GetType().Name));
            }
        ...
        void IList.Insert(int index, object value)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var element = GetElementAtIndex(index, out atCollectionEnd);
                    ...
                    position = atCollectionEnd ? ContentEnd : element.ElementStart;
                }
        ...
        object IList.this[int index]
        {
            ...
            set
            {
                ...
                {
                    // Remove old element.
                    var nextElement = RemoveAtInternal(index);

                    // Insert new element.
                    var position = nextElement == null ? ContentEnd : nextElement.ElementStart;
        ...
        void ICollection.CopyTo(Array array, int arrayIndex)
        {
            ...
            for (var element = FirstChild; element != null; element = (TextElementType)element.NextElement)
            {
        ...
        internal TextElementType FirstChild
        {
            get
            {
                ...
                {
                    firstChild = (TextElementType)((TextElement)Parent).FirstChildElement;
                }
                else
                {
                    TextTreeTextElementNode node = TextContainer.FirstContainedNode as TextTreeTextElementNode;
        ...
        internal TextElementType LastChild
        {
            get
            {
                ...
                if (Parent is TextElement)
                {
                    lastChild = (TextElementType)((TextElement)Parent).LastChildElement;
                }
                else
                {
                    TextTreeTextElementNode node = TextContainer.LastContainedNode as TextTreeTextElementNode;
        ...
        private TextElementType RemoveAtInternal(int index)
        {
            ...
            try
            {
                ...
                var newElementCache = nextElement;
        ...
        private TextPointer ContentStart
        {
            ...
            {
                return
                    Parent is TextElement ? ((TextElement)Parent).ContentStart : TextContainer.Start;
            }
        }
        ...
        private TextPointer ContentEnd
        {
            ...
            {
                return
                    Parent is TextElement ? ((TextElement)Parent).ContentEnd : TextContainer.End;
            }
        }
