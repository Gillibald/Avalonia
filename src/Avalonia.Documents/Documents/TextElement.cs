...
#pragma warning suppress 6506
                    ...
                    try
                    {
                        tree.DeleteContentInternal(ElementStart, ElementEnd);
                    }
                    finally
                    {
                        tree.EndChange();
...
#pragma warning suppress 56506
        ...
        internal bool Contains(TextPointer position)
        {
            ...
            return ContentStart.CompareTo(position) <= 0 && ContentEnd.CompareTo(position) >= 0;
        }
            ...
            else
            {
                ...
                if (uie != null)
                {
                    ...
                    if (inlineContainer != null)
                    {
                        ...
                        {
                            throw new ArgumentException(SR.Get(SRID.TextSchema_ThisInlineUIContainerHasAChildUIElementAlready, GetType().Name, ((InlineUIContainer)this).Child.GetType().Name, value.GetType().Name));
                        }
                    ...
                    else
                    {
                        ...
                        if (blockContainer != null)
                        {
                            ...
                            {
                                throw new ArgumentException(SR.Get(SRID.TextSchema_ThisBlockUIContainerHasAChildUIElementAlready, GetType().Name, ((BlockUIContainer)this).Child.GetType().Name, value.GetType().Name));
                            }
                        ...
                        else
                        {
                            ...
                            {
                                throw new ArgumentException(SR.Get(SRID.TextSchema_ChildTypeIsInvalid, GetType().Name, value.GetType().Name));
                            }
                        }
                    }
                }
        ...
        void IAddChild.AddText(string text)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        throw new InvalidOperationException(SR.Get(SRID.TextSchema_TextIsNotAllowed, GetType().Name));
                    }
        ...
        protected internal override IEnumerator LogicalChildren
        {
            get
            {
                return IsEmpty
                    ...
                    : new RangeContentEnumerator(ContentStart, ContentEnd);
            }
        }
        ...
        protected override void OnPropertyChanged(DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                if (IsInTree) // No work to do if no one's listening.
                {
        ...
        internal int SymbolCount
        {
            get
            {
                return IsInTree ? _textElementNode.SymbolCount : 2;
            }
        }
            ...
            get
            {
                ...
                if (IsIMEStructuralElement)
                {
                    ...
                    else
                    {
                        ...
                        leftEdgeCharCount = TextElementNode.IsFirstSibling ? 0 : 1;
                    }
                }
        ...
        internal virtual bool IsFirstIMEVisibleSibling
        {
            get
            {
                ...
                if (IsIMEStructuralElement)
                {
                    isFirstIMEVisibleSibling = TextElementNode == null ? true : TextElementNode.IsFirstSibling;
                }
