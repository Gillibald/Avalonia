...
namespace Avalonia.Documents
{
    ...
    /// <remarks>
    /// </remarks>
    public abstract class TextElement : Control, IAddChild
    {
        //------------------------------------------------------
        //
        //  Constructors
        ...
        static TextElement()
        {
            ...
            AffectsRender<TextElement>(FontFamilyProperty, FontStyleProperty, FontWeightProperty, FontSizeProperty, ForegroundProperty);
            AffectsMeasure<TextElement>(FontFamilyProperty, FontStyleProperty, FontWeightProperty, FontSizeProperty);
        }
        ...
        internal void Reposition(TextPointer start, TextPointer end)
        {
            ...
            {
                throw new ArgumentException("TextElement_UnmatchedEndPointer");
            }
...
#pragma warning suppress 6506
                ...
                {
                    throw new ArgumentException($"InDifferentScope {start} {end}");
                }
            }
...
#pragma warning suppress 56506
        ...
        /// <summary>
        /// AvaloniaProperty for <see cref="FontFamily" /> property.
        /// </summary>
        ...
        public static readonly AvaloniaProperty FontFamilyProperty =
                AvaloniaProperty.RegisterAttached<TextElement, TextElement, FontFamily>(
                        "FontFamily",FontFamily.Default, true, validate: IsValidFontFamily);
        ...
        public static void SetFontFamily(AvaloniaObject element, FontFamily value)
        {
            if (element == null)
            {
        ...
        public static FontFamily GetFontFamily(AvaloniaObject element)
        {
            if (element == null)
            {
                throw new ArgumentNullException("element");
        ...
        /// <summary>
        /// AvaloniaProperty for <see cref="FontStyle" /> property.
        /// </summary>
        //[CommonAvaloniaProperty]
        public static readonly AvaloniaProperty FontStyleProperty =
                AvaloniaProperty.RegisterAttached<TextElement, TextElement, FontStyle>(
                        "FontStyle", FontStyle.Normal, true);
        ...
        /// <param name="element">The element to which to write the attached property.</param>
        /// <param name="value">The property value to set</param>
        public static void SetFontStyle(AvaloniaObject element, FontStyle value)
        {
            if (element == null)
            {
                throw new ArgumentNullException("element");
        ...
        /// </summary>
        /// <param name="element">The element from which to read the attached property.</param>
        public static FontStyle GetFontStyle(AvaloniaObject element)
        {
            if (element == null)
            {
                throw new ArgumentNullException("element");
        ...
        /// <summary>
        /// AvaloniaProperty for <see cref="FontWeight" /> property.
        /// </summary>
        //[CommonAvaloniaProperty]
        ...
        /// <param name="element">The element to which to write the attached property.</param>
        /// <param name="value">The property value to set</param>
        public static void SetFontWeight(AvaloniaObject element, FontWeight value)
        {
            if (element == null)
            {
                throw new ArgumentNullException("element");
        ...
        /// </summary>
        /// <param name="element">The element from which to read the attached property.</param>
        public static FontWeight GetFontWeight(AvaloniaObject element)
        {
            if (element == null)
            {
                throw new ArgumentNullException("element");
        ...
        /// <param name="element">The element to which to write the attached property.</param>
        /// <param name="value">The property value to set</param>
        //public static void SetFontStretch(AvaloniaObject element, FontStretch value)
        //{
        //    if (element == null)
        //    {
        //        throw new ArgumentNullException("element");
        ...
        /// </summary>
        /// <param name="element">The element from which to read the attached property.</param>
        //public static FontStretch GetFontStretch(AvaloniaObject element)
        //{
        //    if (element == null)
        //    {
        //        throw new ArgumentNullException("element");
        ...
        /// <param name="element">The element to which to write the attached property.</param>
        /// <param name="value">The property value to set</param>
        public static void SetFontSize(AvaloniaObject element, double value)
        {
            if (element == null)
            {
                throw new ArgumentNullException("element");
        ...
        /// <param name="element">The element from which to read the attached property.</param>
        //[TypeConverter(typeof(FontSizeConverter))]
        public static double GetFontSize(AvaloniaObject element)
        {
            if (element == null)
            {
                throw new ArgumentNullException("element");
        ...
        /// <summary>
        /// AvaloniaProperty for <see cref="Foreground" /> property.
        /// </summary>
        //[CommonAvaloniaProperty]
        ...
        /// <param name="element">The element to which to write the attached property.</param>
        /// <param name="value">The property value to set</param>
        public static void SetForeground(AvaloniaObject element, Brush value)
        {
            if (element == null)
            {
                throw new ArgumentNullException("element");
        ...
        /// </summary>
        /// <param name="element">The element from which to read the attached property.</param>
        public static Brush GetForeground(AvaloniaObject element)
        {
            if (element == null)
            {
                throw new ArgumentNullException("element");
        ...
        public static readonly AvaloniaProperty BackgroundProperty =
                AvaloniaProperty.Register<TextElement, IBrush>("Background");
        ...
        internal static TypographyProperties GetTypographyProperties(AvaloniaObject element)
        {
        ...
        private static void OnTypographyChanged(AvaloniaObject element, AvaloniaPropertyChangedEventArgs e)
        {
