...
namespace Avalonia.Media.Fonts
{
    ...
    internal static class FontFallbackScriptHints
    {
        ...
        /// targeted page.
        /// </summary>
        internal static int CountCjkCodePageGroups(FontCodePageCoverage coverage)
        {
            var count = 0;
        ...
        /// </summary>
        internal static int ScoreDeclaredCoverage(GlyphTypeface candidate, CultureInfo culture)
        {
            if (candidate.DeclaresLanguageCoverage(culture))
            {
                return 4;
        ...
        /// Japanese font.
        /// </summary>
        internal static int ScoreFamilyNames(IReadOnlyDictionary<CultureInfo, string> familyNames, CultureInfo culture)
        {
        ...
        /// </summary>
        internal static bool HasChineseDesignEvidence(GlyphTypeface candidate)
        {
