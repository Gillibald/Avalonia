...
namespace Avalonia.Media
{
    ...
    public sealed class GlyphTypeface
    {
        ...
        /// clone in pr4e1), the variation position, and the lazy shaper typeface
        ...
        private GlyphTypeface(GlyphTypeface source, IPlatformTypeface platformTypeface, NormalizedVariationPosition variation)
        {
            ...
            // clones identify by their normalized variation position, not by these properties.
        ...
        /// <see cref="GlyphTypeface"/> tracks the requested position, and downstream
        /// consumers that read <see cref="VariationPosition"/> (the gvar deformation
