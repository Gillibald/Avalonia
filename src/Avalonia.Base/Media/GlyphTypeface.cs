...
namespace Avalonia.Media
{
    ...
    public sealed class GlyphTypeface
    {
        ...
        public IGeometryImpl? GetGlyphOutline(ushort glyphIndex)
        {
            ...
            return (IGeometryImpl?)cache.GetOrAdd(glyphIndex, BuildOutlineEntry).Payload;
        }
        ...
        /// </summary>
        private GlyphCacheEntry BuildOutlineEntry(ushort glyphIndex)
        {
            ...
            return new GlyphCacheEntry(glyphIndex, kind, outline, cost, dependencies, outline?.Bounds ?? default);
        }
