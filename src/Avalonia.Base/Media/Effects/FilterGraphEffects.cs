...
internal interface IFloodEffect : IEffect
{
    Color Color { get; }
...
internal class ImmutableFloodEffect : IFloodEffect, IImmutableEffect
{
...
/// </summary>
internal interface IMergeEffect : IEffect
{
    IReadOnlyList<IEffect?> Inputs { get; }
}

internal class ImmutableMergeEffect : IMergeEffect, IImmutableEffect
{
...
/// </summary>
internal interface IBlendEffect : IEffect
{
...
internal class ImmutableBlendEffect : IBlendEffect, IImmutableEffect
{
...
/// </summary>
internal interface IArithmeticCompositeEffect : IEffect
{
    double K1 { get; }
...
internal class ImmutableArithmeticCompositeEffect : IArithmeticCompositeEffect, IImmutableEffect
{
...
/// </summary>
internal interface ITileEffect : IEffect
{
    Rect Source { get; }
...
internal class ImmutableTileEffect : ITileEffect, IImmutableEffect
{
...
/// </summary>
internal interface IMorphologyEffect : IEffect
{
    double RadiusX { get; }
...
internal class ImmutableMorphologyEffect : IMorphologyEffect, IImmutableEffect
{
