...
/// </summary>
internal interface ILightingEffect : IEffect
{
...
internal class ImmutableLightingEffect : ILightingEffect, IImmutableEffect
{
...
/// </summary>
internal interface IComponentTransferEffect : IEffect
{
...
internal class ImmutableComponentTransferEffect : IComponentTransferEffect, IImmutableEffect
{
...
internal enum ConvolveMatrixEdgeMode
{
    Duplicate,
    Wrap,
    None,
...
/// </summary>
internal interface IConvolveMatrixEffect : IEffect
{
    int OrderX { get; }
...
internal class ImmutableConvolveMatrixEffect : IConvolveMatrixEffect, IImmutableEffect
{
...
/// </summary>
internal interface ICropEffect : IEffect
{
    Rect Rect { get; }
...
internal class ImmutableCropEffect : ICropEffect, IImmutableEffect
{
