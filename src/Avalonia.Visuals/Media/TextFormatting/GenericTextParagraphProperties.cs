namespace Avalonia.Media.TextFormatting
{
    ...
    public sealed class GenericTextParagraphProperties : TextParagraphProperties
    {
        ...
        public GenericTextParagraphProperties(TextParagraphProperties textParagraphProperties)
        {
            ...
            DefaultTextRunProperties = textParagraphProperties.DefaultTextRunProperties;
            _textAlignment = textParagraphProperties.TextAlignment;
            _lineHeight = textParagraphProperties.LineHeight;
            FirstLineInParagraph = textParagraphProperties.FirstLineInParagraph;
            AlwaysCollapsible = textParagraphProperties.AlwaysCollapsible;
            _textWrap = textParagraphProperties.TextWrapping;
            Indent = textParagraphProperties.Indent;
        }
