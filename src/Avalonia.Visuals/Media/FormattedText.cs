...
#pragma warning restore 6506
        ...
        /// </summary>
        internal void Draw(IDrawingContextImpl drawingContext, Point origin)
        {
        ...
        private CachedMetrics DrawAndCalculateMetrics(IDrawingContextImpl drawingContext, Point drawingOffset, bool getBlackBoxMetrics)
        {
