...
namespace RenderDemo.Pages
{
    ...
    ///
    /// This is the mechanism the Image control's composition-image host automates
    /// for an animating <see cref="Avalonia.Media.IImage"/> source (see
    /// CompositionImageHost); here it is wired by hand from the public primitives so
    /// the moving parts are visible. Contrast the neighbouring DrawingRecording page,
    /// which replays a recording through DrawingContext.DrawRecording every frame.
    /// </summary>
