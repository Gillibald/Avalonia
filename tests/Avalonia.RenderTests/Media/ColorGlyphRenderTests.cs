...
namespace Avalonia.Skia.RenderTests
{
    ...
    public class ColorGlyphRenderTests : TestBase
    {
        ...
        /// </summary>
        private static byte[] BuildColrV0(ushort baseGlyph, params (ushort GlyphIndex, ushort PaletteEntry)[] layers)
        {
            ...
            foreach (var (glyphIndex, paletteEntry) in layers)
            {
                colr.UInt16(glyphIndex).UInt16(paletteEntry);
            }
